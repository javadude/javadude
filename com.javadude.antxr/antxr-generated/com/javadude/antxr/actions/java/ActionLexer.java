	...
	public final void mACTION(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
				...
				if ( _cnt414>=1 ) { break _loop414; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt414++;
		} while (true);
...
inputState.guessing--;
	...
	protected final void mATTRIBUTE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if (((LA(1)==':') && (_tokenSet_5.member(LA(2))) && (true))) {
			int _m514 = mark();
...
inputState.guessing--;
	...
	protected final void mTEXT_ITEM(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if ((LA(1)=='$') && (LA(2)=='F') && (LA(3)=='O')) {
			...
			if (((_tokenSet_6.member(LA(1))) && (_tokenSet_7.member(LA(2))) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff')))) {
				int _m434 = mark();
...
inputState.guessing--;
	...
	protected final void mID(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop504:
		do {
			if ((_tokenSet_10.member(LA(1))) && (true) && (true)) {
				{
				switch ( LA(1)) {
				case 'a':  case 'b':  case 'c':  case 'd':
				case 'e':  case 'f':  case 'g':  case 'h':
...
inputState.guessing--;
			...
			if ( synPredMatched554 ) {
				...
				if ( _cnt555>=1 ) { break _loop555; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mTEXT_ARG(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_11.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && (true)) {
				...
				if ( _cnt478>=1 ) { break _loop478; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		case '[':
		{
			...
			do {
				if ((LA(1)=='[')) {
					...
					if ( _cnt471>=1 ) { break _loop471; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
				}
 ...
 */
	...
	protected final void mINT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt544>=1 ) { break _loop544; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mARG(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop499:
		do {
			if ((_tokenSet_18.member(LA(1))) && (_tokenSet_19.member(LA(2))) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
				{
				switch ( LA(1)) {
				case '\t':  case '\n':  case '\r':  case ' ':
				{
	...
	protected final void mTEXT_ARG_ID_ELEMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		id=_returnToken;
		{
		if ((_tokenSet_4.member(LA(1))) && (_tokenSet_20.member(LA(2))) && (true)) {
			_saveIndex=text.length();
			mWS(false);
			text.setLength(_saveIndex);
		}
		...
		case '(':
		{
			match('(');
			{
			if ((_tokenSet_4.member(LA(1))) && (_tokenSet_21.member(LA(2))) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
				_saveIndex=text.length();
				mWS(false);
				text.setLength(_saveIndex);
			}
			else if ((_tokenSet_21.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && (true)) {
			}
			else {
				throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());
			}
			...
			_loop487:
			do {
				if ((_tokenSet_22.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
					mTEXT_ARG(false);
					{
					_loop486:
					do {
		...
		case '[':
		{
			...
			do {
				if ((LA(1)=='[')) {
					...
					else if ((_tokenSet_22.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
					}
					else {
						throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());
					}
					...
					if ( _cnt492>=1 ) { break _loop492; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
				}
	...
	protected final void mINT_OR_FLOAT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop547:
		do {
			if (((LA(1) >= '0' && LA(1) <= '9')) && (_tokenSet_23.member(LA(2))) && (true)) {
				mDIGIT(false);
			}
			else {
				if ( _cnt547>=1 ) { break _loop547; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		{
		if ((LA(1)=='L') && (_tokenSet_24.member(LA(2))) && (true)) {
			match('L');
		}
		else if ((LA(1)=='l') && (_tokenSet_24.member(LA(2))) && (true)) {
			match('l');
		}
		else if ((LA(1)=='.')) {
			match('.');
		...
		else if ((_tokenSet_24.member(LA(1))) && (true) && (true)) {
		}
		else {
			throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());
		}
	...
	protected final void mATTRID(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ATTRID;
		int _saveIndex;
		...
		_loop509:
		do {
			if ((_tokenSet_25.member(LA(1))) && (true) && (true)) {
				{
				switch ( LA(1)) {
				case 'a':  case 'b':  case 'c':  case 'd':
				case 'e':  case 'f':  case 'g':  case 'h':
...
inputState.guessing--;
	...
	protected final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)=='*') && (LA(2)=='/') && (true)) break _loop528;
...
inputState.guessing--;
	...
	private static final long[] mk_tokenSet_5() {
		long[] data = { 105553116266496L, 576460745995190270L, 0L, 0L, 0L};
		return data;
	}
