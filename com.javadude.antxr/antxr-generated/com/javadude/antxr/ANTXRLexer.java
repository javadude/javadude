...
public ANTXRLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTXRHashString("options", this), new Integer(52));
	literals.put(new ANTXRHashString("charVocabulary", this), new Integer(20));
	literals.put(new ANTXRHashString("public", this), new Integer(33));
	literals.put(new ANTXRHashString("header", this), new Integer(5));
	literals.put(new ANTXRHashString("protected", this), new Integer(32));
	literals.put(new ANTXRHashString("returns", this), new Integer(37));
	literals.put(new ANTXRHashString("Parser", this), new Integer(31));
	literals.put(new ANTXRHashString("throws", this), new Integer(38));
	...
	literals.put(new ANTXRHashString("private", this), new Integer(34));
	literals.put(new ANTXRHashString("exception", this), new Integer(40));
	literals.put(new ANTXRHashString("tokens", this), new Integer(4));
	literals.put(new ANTXRHashString("class", this), new Integer(10));
	literals.put(new ANTXRHashString("catch", this), new Integer(41));
}
	...
	public final void mINT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt382>=1 ) { break _loop382; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
