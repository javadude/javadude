 ...
 * 	would like.
 **/
/*$classAccess$*/abstract class $className$Gen
			...
			implements Cloneable							//? cloneable
{
	...
	//#END
	protected $className$Gen(/*$superConstructorArgs$*/) {
		/*$superConstructorSuperCall$*/;					//? superConstructorSuperCall
		//#FOREACH delegates
	 ...
	 **/
	public abstract $returnType$ $name_1$(/*$argDecls$*/)/*$throwsClause$*/;			//? abstract
	public $returnType$ $name_2$(/*$argDecls$*/)/*$throwsClause$*/ {					//? !abstract
